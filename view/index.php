...
<body>
    ...
    <!-- <script>
        function addToCart(productName, productPrice) {
            ...
            xhr.send("action=add&name=" + productName + "&price=" + productPrice);
        }
    </script> -->
        ...
        <section class='py-5 text-center container'>
            <div class='row py-lg-5'>
                <div class='col-lg-6 col-md-8 mx-auto'>
                    ...
                    <p>
                        <a href='../cart/cart2.php' class='btn btn-primary my-2'>Đến giỏ hàng</a>
                        ...
                        <div class='card shadow-sm'>
                            ...
                            <div class='card-body'>
                                ...
                                <div class='d-flex justify-content-between align-items-center'>
                                    ...
                                    <div>
                                        <button /*onclick=\"addToCart($tenMonAn,$giaNiemYet)\"*/ class='btn btn-outline-secondary-1'>Thêm vào giỏ hàng</button>
                                    </div>
